...
class Themes {
  static final lightTheme = ThemeData(
    colorScheme: const ColorScheme.light(
      ...
      primaryContainer: AppColors.predictTableLight1,
      secondaryContainer: AppColors.predictTableLight2,
      tertiaryContainer: AppColors.predictTableLight3,
    ),
  ...
  static final darkTheme = ThemeData(
    colorScheme: const ColorScheme.dark(
      ...
      primaryContainer: AppColors.predictTableDark1,
      secondaryContainer: AppColors.predictTableDark2,
      tertiaryContainer: AppColors.predictTableDark3,
    ),
